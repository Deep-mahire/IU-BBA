...
function FinanceManagementPlacement() {
    ...
    <div className="px-8 md:px-16 py-4">
      <div className="flex space-x-4">
        ...
        <div className="w-1/2 flex flex-col items-center">
          ...
          <h2 className="text-4xl font-semibold text-[#388A86] mb-4">Top Placements</h2>
          {/* Placement Image */}
          <img
        ...
        <div className="w-1/2 flex flex-col items-center">
          ...
          <h2 className="text-4xl font-semibold text-[#388A86] mb-4">Our Recruiters</h2>
          {/* Recruiters Grid */}
...
export default FinanceManagementPlacement;
