  ...
  return (
    <div className="flex px-8 md:px-16 py-12 mb-12 poppins-regular h-screen">
      ...
      <div className="w-[50%] pl-8 flex flex-col">
        ...
        <h1 className="text-4xl font-extralight text-left text-[#388A86] mb-6">
          Finance Management Program
        </h1>
        <p className="text-left text-lg mb-6 text-[#000000]">
          Indira University offers an innovative Finance Management program that integrates financial theory with practical, real-world applications. Students gain insights into financial markets, investment strategies, and financial management essential for a successful career in finance.
        </p>
        ...
        <div className="grid grid-cols-2 grid-rows-3 gap-6 flex-grow">
          ...
          <div className="bg-[#f1f7f6] p-4 shadow-lg shadow-[#388A86]/50 flex justify-between items-center rounded-lg">
            <span className="flex items-center">
              <FaBullhorn className="text-[#388A86] mr-4 text-4xl" />
          ...
          <div className="bg-[#f1f7f6] p-4 shadow-lg shadow-[#388A86]/50 flex justify-between items-center rounded-lg">
            <span className="flex items-center">
              <FaHandshake className="text-[#388A86] mr-4 text-4xl" />
          ...
          <div className="bg-[#f1f7f6] p-4 shadow-lg shadow-[#388A86]/50 flex justify-between items-center rounded-lg">
            <span className="flex items-center">
              <FaChartLine className="text-[#388A86] mr-4 text-4xl" />
              <span className="text-sm text-[#000000]">INNOVATIVE FINANCE STRATEGIES</span>
            </span>
          </div>
          {/* Card 4 */}
          <div className="bg-[#f1f7f6] p-4 shadow-lg shadow-[#388A86]/50 flex justify-between items-center rounded-lg">
            <span className="flex items-center">
              <FaRegCalendarAlt className="text-[#388A86] mr-4 text-4xl" />
              <span className="text-sm text-[#000000]">
          ...
          <div className="bg-[#f1f7f6] p-4 shadow-lg shadow-[#388A86]/50 flex justify-between items-center rounded-lg">
            <span className="flex items-center">
              <FaPenAlt className="text-[#388A86] mr-4 text-4xl" />
              <span className="text-sm text-[#000000]">HANDS-ON FINANCIAL ANALYSIS</span>
            </span>
          </div>
          {/* Card 6 */}
          <div className="bg-[#f1f7f6] p-4 shadow-lg shadow-[#388A86]/50 flex justify-between items-center rounded-lg">
            <span className="flex items-center">
              <FaUsers className="text-[#388A86] mr-4 text-4xl" />
