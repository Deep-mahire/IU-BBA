...
function HumanResourceHighlights() {
  useEffect(() => {
    AOS.init({
      ...
      <div className="px-8 md:px-16 py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div
            ...
            data-aos-delay="100"
          >
            <div className="w-12 h-12 bg-[#2A9D] text-white rounded-full flex items-center justify-center mb-4"> {/* Fresh green color */}
...
export default HumanResourceHighlights;
